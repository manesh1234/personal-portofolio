...
const Nav = () => {
    ...
    return (
        <nav>
            ...
            <a href="#src_projects__vV-IJ" onClick={()=>setState('#services')} className={activeState==='#projects' ? styles.active : ''}  title="projects"><FcServices /></a>
            <a href="#src_contact__JnrQG" onClick={()=>setState('#contact')} className={activeState==='#contact' ? styles.active : ''} title="contact"><BsMessenger /></a>
        </nav>
    )
}
